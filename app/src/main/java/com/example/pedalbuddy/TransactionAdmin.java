...
public class TransactionAdmin extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_menu) {
            Intent i = new Intent(TransactionAdmin.this, Menu.class); // Use TransactionAdmin.this
            startActivity(i);
            finish();
        } else if (itemId == R.id.nav_profile) {
            Intent i1 = new Intent(TransactionAdmin.this, Profile.class); // Use TransactionAdmin.this
            startActivity(i1);
...
//
//                    buffer.append("Amount: BDT. " + (Integer.parseInt(data[6]) * days)+"\n\n");
//
//                    String user_rating;
//                    String cycle_rating;
//
